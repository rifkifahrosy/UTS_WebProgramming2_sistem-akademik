...
@section('page-subtitle', 'Perbarui data jurusan')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0" style="font-size:0.95rem; font-weight:600;">
                    <i class="bi bi-pencil-square me-2" style="color:#4f46e5;"></i>Edit Jurusan
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('jurusan.update', $jurusan->id_jurusan) }}" method="POST" id="formEditJurusan">
                    @csrf @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" id="btn-update-jurusan"
