...
@section('page-subtitle', 'Perbarui data mata kuliah')
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0" style="font-size:0.95rem; font-weight:600;">
                    <i class="bi bi-pencil-square me-2" style="color:#10b981;"></i>Edit Mata Kuliah
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('matakuliah.update', $matakuliah->id_matakuliah) }}" method="POST" id="formEditMatakuliah">
                    @csrf @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" id="btn-update-matakuliah"
